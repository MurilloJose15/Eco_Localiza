...
class _EditCompanyScreenState extends State<EditCompanyScreen> {
  ...
  late final TextEditingController _namecompanyController;
 ...
 /* EditCompanyScreen({Key? key, required this.company})
    : _namecompanyController = TextEditingController(text: company.company_name),
      _addressController = TextEditingController(text: company.address),
      selectedItems = List<String>.from(company.trash_type),
      super(key: key);*/
